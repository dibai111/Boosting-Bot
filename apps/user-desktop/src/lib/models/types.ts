...
/** 定義前後端傳輸模型；snake_case 欄位對應 Rust serde，畫面衍生狀態使用 camelCase。 */
export type AuthKind = "microsoft" | "access_token" | "cookie";
export type BotPhase =
  "offline" | "starting" | "authenticating" | "connecting" | "online" | "stopping" | "error";
export type RuntimeMode = "idle" | "matching" | "nick_roller";
export type NickRollerPhase =
  | "idle"
  | "preparing"
  | "rolling"
  | "awaiting_decision"
...
export type MatchmakingPhase =
  "idle" | "awaiting_player" | "matching" | "committed" | "in_game" | "failed";
